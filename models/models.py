...
class Customer(db.Model):
    ...
    order_history = db.relationship('OrderHistory', backref='customer', cascade='all, delete')
...
class OrderHistory(db.Model):
    ...
    order_items = db.relationship('OrderItem', backref="orders_history", cascade='all, delete')
