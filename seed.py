...
def seed():
    ...
    customer3 = Customer(name = "Roberto Smith", phone = "01553678432", address = "742 Evergreen Terrace, Springton-On-Sea")
    customer4 = Customer(name = "Danny Almond", phone = "01435674892", address = "4 Crouch Lane, London")
