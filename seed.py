...
def seed():
    ...
    Menu.query.delete()
    customer1 = Customer(name = "Jenny Wholesome", address = "42 Arcadia Rd, Tadford")
    customer2 = Customer(name = "Elle Abbot", address = "19 Belle Vue Rd, Colchester")
    customer3 = Customer(name = "Roberto Smith", address = "742 Evergreen Terrace, Springton-On-Sea")
    customer4 = Customer(name = "Danny Almond", address = "4 Crouch Lane, London")
